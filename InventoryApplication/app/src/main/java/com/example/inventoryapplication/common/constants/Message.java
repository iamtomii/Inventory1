...
public class Message {
    ...
    public static final String MESSAGE_CONFIRM_DELETE_RECORD = "Do you want to delete this record?";
    public static final String MESSAGE_CONFIRM_DELETE_ALL = " Are you sure, remove all data?";
    ...
    public static final String MESSAGE_CONFIRM_REGISTER_DATA = "Unregistered data.\n Do you want to save?";
    public static final String MESSAGE_CONFIRM_OVER_DATA = "Data limit has been reached %s records.\nYou must save this data to continue.";
    public static final String MESSAGE_CONFIRM_EXPORT_DATA = "Do you want to export data?";
    public static final String MESSAGE_CONFIRM_REMOVE_ADD_DATA = "Do you want to delete all data after exporting?";
